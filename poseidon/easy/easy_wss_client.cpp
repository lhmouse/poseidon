...
struct Final_WSS_Client_Session final : WSS_Client_Session
  {
    ...
    explicit
    Final_WSS_Client_Session(const Easy_WSS_Client::thunk_type& thunk, const shptr<Event_Queue>& queue,
...
connect(chars_view addr)
  {
    ...
    auto session = new_sh<Final_WSS_Client_Session>(this->m_thunk, queue,
