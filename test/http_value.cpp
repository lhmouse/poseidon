...
main()
  {
    HTTP_Value hval;
    POSEIDON_TEST_CHECK(hval.index() == HTTP_Value::index_null);
    POSEIDON_TEST_CHECK(hval.is_null());
    POSEIDON_TEST_CHECK(hval.print_to_string() == "");

    hval.set_number(42.5);
    POSEIDON_TEST_CHECK(hval.index() == HTTP_Value::index_number);
    ...
    POSEIDON_TEST_CHECK(hval.index() == HTTP_Value::index_string);
    ...
    POSEIDON_TEST_CHECK(hval.index() == HTTP_Value::index_datetime);
