...
#pragma GCC diagnostic ignored "-Wconversion"
    ...
    constexpr UUID(const fields& fs) noexcept
      :
        m_data_1_3(fs.time_low >> 24), m_data_1_2(fs.time_low >> 16),
        m_data_1_1(fs.time_low >> 8), m_data_1_0(fs.time_low),
        m_data_2_1(fs.time_mid >> 8), m_data_2_0(fs.time_mid),
        m_data_3_1(fs.time_hi_and_version >> 8), m_data_3_0(fs.time_hi_and_version),
        m_data_4_1(fs.clk_seq_res >> 8), m_data_4_0(fs.clk_seq_res),
        m_data_5_5(fs.node >> 40), m_data_5_4(fs.node >> 32), m_data_5_3(fs.node >> 24),
        m_data_5_2(fs.node >> 16), m_data_5_1(fs.node >> 8), m_data_5_0(fs.node)
      { }
