...
struct Final_Fiber final : Abstract_Fiber
  {
    ...
    Final_Fiber(const Easy_WS_Server::thunk_type& thunk, shptrR<Session_Table> sessions,
...
struct Final_Acceptor final : TCP_Acceptor
  {
    ...
    Final_Acceptor(const Easy_WS_Server::thunk_type& thunk, const IPv6_Address& addr,
                   shptrR<Session_Table> sessions)
      :
