...
main()
  {
    ...
    POSEIDON_TEST_CHECK(hval.to_string() == R"({$base64:"An8A8vz//g=="})");
    ...
    POSEIDON_TEST_CHECK(hval.to_string() == R"([1,false,"meow"])");
    ...
    POSEIDON_TEST_CHECK(hval.to_string() == R"({"first":false})");
    ...
    POSEIDON_TEST_CHECK(hval.to_string() == R"({"first":"meow","second":12.5})");
    ...
    POSEIDON_TEST_CHECK(hval.to_string() == R"({$oid:"65c98f342d1860b7baef94fb"})");
    ...
    POSEIDON_TEST_CHECK(hval.to_string() == R"({$date:{$numberLong:"1633635291000"}})");
  }
