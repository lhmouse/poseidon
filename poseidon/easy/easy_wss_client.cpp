...
struct Final_Fiber final : Abstract_Fiber
  {
    ...
    Final_Fiber(const Easy_WSS_Client::thunk_type& thunk, shptrR<Session_Table> sessions,
...
struct Final_Session final : WSS_Client_Session
  {
    ...
    Final_Session(const Easy_WSS_Client::thunk_type& thunk, shptrR<Session_Table> sessions,
