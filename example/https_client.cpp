...
my_timer_callback(const shptr<Abstract_Timer>& timer,
                  Abstract_Fiber& fiber, steady_time now)
  {
    ...
    switch(state)
      ...
      case 1:
        {
          ...
          POSEIDON_LOG_ERROR(("example HTTPS client: $1 $2"), req.method_str, req.raw_path);
        }
        break;
      ...
      default:
        POSEIDON_LOG_ERROR(("example HTTPS client shutting down"));
        my_client_session->ssl_shut_down();
